...
En las Ciencias Experimentales, la **reproducibilidad** es un componente muy importante para darle validez a los descubrimientos y es una parte del método científico. Es por ello que en los trabajos científicos, una sección importante es la de _Materiales y Métodos_ donde se describen los pasos que se deben dar para poder reproducir los resultados.

La Ciencia de Datos en general, y en la aplicada a otras ciencias, la **reproducibilidad computacional** es clave ya que en el procesamiento de datos se toman una serie de decisiones que afectan el resultado. 

¿Qué significa esto? Dada una serie de datos de entrada, el flujo de trabajo que se aplica para _importar_, _ordenar_, _transformar_, _visualizar_ y _modelar_ los datos, es decir, convertirlos en información, debe estar correctamente **documentado** para que cualquier persona pueda entender la lógica y eventualemente repetirlo para llegar a los mismos resultados.


 Aiming for reproducibility is also a cornerstone of open science practices. Fully reproducible meta-analyses make it as transparent as possible to others how we ended up with our results.
