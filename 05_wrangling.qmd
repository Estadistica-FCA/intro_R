...
Tenemos más procedencias porque **R** interpreta que si no tienen el mismo texto, son distintas. ¿Cómo solucionarlo?
...
```{r}
procedencia <- factor(procedencia, levels = c("Alam", "Alameda", "La Alameda", "Las Alamedas", "Alamedas"))
procedencia
```
