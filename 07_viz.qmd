...
Por su parte las funciones `stat_` indicancomo esos datos se van a resumir o procesar para su representación gráfica. Ejemplo: promedio, agrupamiento y conteo de observaciones, o ajuste de un modelo lineal o suavizado, etc.
...
Gráfico barras según la Procedencia (variable categórica):
...
1. Guarde los gráficos generados en las actividades anteriores en objetos `g1` y `g2`
