...
::: {.callout-caution icon=true title="Nombres" collapse=true}
...
::: {.callout-caution icon=true title="Mayúsculas" collapse=true}
...
2. Avanzado: crear una función más avanzada llamada _area_ que calcule el área de un rectángulo o círculo indicando en el argumento `figura` y suminisitrando el dato de base y altura o altura, según corresponda.
